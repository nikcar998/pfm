...
// Salvataggio di tutte le transazioni nel repository
    ...
    public  List<Transaction> addTransactionsWithDescription(Account account1, String descrizione, BigDecimal amount, Boolean addTransaction){
        ...
        if(descrizione == null) {
            ...
            transaction2.setNumeroOrdine("INTER2019283344056");
            transaction2.setOrdinante("Carrozza Nicolo");
            transaction2.setFiliale("Milano");
            ...
            transaction2.setBic("BPMOIT22XXX");
            transaction2.setDebitoreEffettivo("");
            transaction2.setCreditoreEffettivo("");
            transaction2.setIdentificativoBonifico("");
            ...
            transaction2.setTRN("0321243443923423423333100T");
            ...
            transaction3.setNumeroOrdine("INTER2019283344056");
            transaction3.setOrdinante("Carrozza Nicolo");
            transaction3.setFiliale("Milano");
            ...
            transaction3.setBic("BPMOIT22XXX");
            transaction3.setDebitoreEffettivo("");
            transaction3.setCreditoreEffettivo("");
            transaction3.setIdentificativoBonifico("");
            ...
            transaction3.setTRN("0321243443923423423333100T");
